...
# Lint as: python3
"""Defines the stella robot related constants and URDF specs."""
...
# Will be default to (0, 0, 0, 1) once the new stella_toes_zup.urdf checked in.
INIT_ORIENTATION = pyb.getQuaternionFromEuler([math.pi / 2.0, 0, math.pi / 2.0])

# Can be different from the motors, although for stella they are the same list.
JOINT_NAMES = (
    # front right leg
...
# Note this matches the Stella SDK/control convention, but is different from
